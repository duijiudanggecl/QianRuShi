...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        BY001_button->setGeometry(QRect(120, 240, 171, 51));
        main_input = new QTextEdit(centralwidget);
        main_input->setObjectName("main_input");
        main_input->setGeometry(QRect(120, 160, 331, 51));
        label_2 = new QLabel(centralwidget);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(30, 170, 101, 31));
        QFont font;
        font.setPointSize(14);
        label_2->setFont(font);
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(30, 320, 53, 31));
        label_3->setFont(font);
        main_output = new QTextEdit(centralwidget);
        main_output->setObjectName("main_output");
        main_output->setGeometry(QRect(120, 320, 181, 31));
